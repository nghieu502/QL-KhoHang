...
namespace KhoHang
{
    public partial class fSupplier : Form
    {
        ...
        void BindingData()
        {
            tbID.DataBindings.Add(new Binding("Text", dgv.DataSource, "idNCC", true, DataSourceUpdateMode.Never));
            tbName.DataBindings.Add(new Binding("Text", dgv.DataSource, "tenNCC", true, DataSourceUpdateMode.Never));
            tbAddr.DataBindings.Add(new Binding("Text", dgv.DataSource, "diaChiNCC", true, DataSourceUpdateMode.Never));
            tbPhone.DataBindings.Add(new Binding("Text", dgv.DataSource, "sdtNCC", true, DataSourceUpdateMode.Never));
            tbEmail.DataBindings.Add(new Binding("Text", dgv.DataSource, "emailNCC", true, DataSourceUpdateMode.Never));
        }
        ...
        private void btUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Có lỗi khi sửa thông tin nhà cung cấp", "Thông báo");
            }
        }
